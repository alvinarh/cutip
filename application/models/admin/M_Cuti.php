...
class M_Cuti extends CI_Model {
  ...
  {
    $query = "SELECT * from permohonan_cuti where keterangan = 'Cuti Sakit' ";
		return $this->db->query($query)->result();
  }

  public function cutiMelahirkan()
  {
    $query = "SELECT * from permohonan_cuti where keterangan = 'Cuti Melahirkan' ";
		return $this->db->query($query)->result();
  }

  public function cutiAlasanPenting()
  {
    $query = "SELECT * from permohonan_cuti where keterangan = 'Cuti Alasan Penting' ";
		return $this->db->query($query)->result();
  }
