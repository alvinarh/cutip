...
class M_Laporan extends CI_Model
{
	...
	{
		$query = "SELECT u.kode_pegawai,u.jabatan, p.* from permohonan_cuti p , user u where  u.kode_pegawai = p.kode_pegawai and p.keterangan = 'Cuti Sakit' and u.kode_pegawai = '$kode_pegawai'";
