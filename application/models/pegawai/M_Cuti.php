...
class M_Cuti extends CI_Model
{
  ...
  {
    $query = "SELECT * from permohonan_cuti where kode_pegawai = '$kode_pegawai' and keterangan = 'Cuti Sakit' ";
		return $this->db->query($query)->result();
  }

  public function cutiMelahirkan($kode_pegawai)
  {
    $query = "SELECT * from permohonan_cuti where kode_pegawai = '$kode_pegawai' and keterangan = 'Cuti Melahirkan' ";
		return $this->db->query($query)->result();
  }

  public function cutiAlasanPenting($kode_pegawai)
  {
    $query = "SELECT * from permohonan_cuti where kode_pegawai = '$kode_pegawai' and keterangan = 'Cuti Alasan Penting' ";
		return $this->db->query($query)->result();
  }
  ...
  public function cetakCutiSakit($kode_pegawai)
  {
    ...
    $this->db->where ('permohonan_cuti.keterangan', 'Cuti Sakit');
