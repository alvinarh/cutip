...
<div class="col-md-4 stretch-card grid-margin" >
              ...
              <div class="col-md-4 stretch-card grid-margin" >
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('admin/Cuti/cutiTahunan') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
                ...
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('admin/Cuti/cutiBesar') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin" >
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('admin/Cuti/cutiDiluarTN') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
