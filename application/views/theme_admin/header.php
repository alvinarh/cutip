                ...
                <br> </br>
                    ...
                    <li class="nav-item <?php if($pp){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/Cuti/cutiSakit') ?>">Cuti Sakit</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/Cuti/cutiBesar') ?>">Cuti Besar</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/Cuti/cutiTahunan') ?>">Cuti Tahunan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/Cuti/cutiDiluarTN') ?>">Cuti Diluar Tanggungan Negara</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item <?php if($lp){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic3">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiSakit') ?>">Laporan Sakit</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiMelahirkan') ?>">Laporan Melahirkan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiAlasanPenting') ?>">Laporan Alasan Penting</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiBesar') ?>">Laporan Besar</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiTahunan') ?>">Laporan Tahunan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('admin/LaporanCuti/cutiDiluarTN') ?>">Cuti Diluar Tanggungan Negara</a></li>
                            </ul>
                        </div>
                    </li>
