                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h6>SISTEM CUTI PEGAWAI NON ASN</h6>
                                    <h2>SICUPI</h2>
                                    <p>Sebuah aplikasi yang memudahkan untuk melakukan cuti pegawai di DPRD Jateng</p>
                                </div>
                                <div class="col-lg-12">
                    ...
                    <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="about-right-content">
                            <div class="section-heading">
                                <h6>About Us</h6>
                                <h4>Apa Itu <em>SICUPI</em></h4>
                                <div class="line-dec"></div>
                            </div>
                            <p>Aplikasi cuti pegawai, yang dapat memudahkan mendata cuti pegawai di DPRD Jateng</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="menu">
                                    ...
                                    <div>
                                        <div class="thumb">
                                            ...
                                            <h6>Cuti Alasan Penting diberikan paling lama 1 (satu) bulan.</h6>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="thumb">
