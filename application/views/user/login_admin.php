                        ...
                        <div class="p-5">
                            <div class="text-center">
                             ...
                             <div class="text-right">
                                <a href="<?php echo base_url('user/login_pegawai');?>" style="background: #4682B4;" class="btn btn-primary mr-3">Pegawai </a>
                                <a href="<?php echo base_url('user/login_admin');?>" style="background: #4682B4;" class="btn btn-warning">Admin</a>
                            ...
                            <form class="user">
                                <div class="form-group">
                                   <input type="text" class="form-control" id="exampleFirstName" aria-describedby="emailHelp" placeholder="Email" name="email">
                                </div>
                                 <div class="form-group">
