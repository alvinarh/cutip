                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-right">
                                <a href="<?php echo base_url('user/login_pegawai'); ?>" style="background: #4682B4;" class="btn btn-primary">Pegawai</a>
                                <a href="<?php echo base_url('user/login_admin'); ?>" style="background: #4682B4;" class="btn btn-warning ml-3">Admin</a>
                                <a href="<?php echo base_url('user/login_pimpinan'); ?>" style="background: #4682B4;" class="btn btn-warning">Pimpinan</a>
                            </div>
                            <br>
                            <div class="text-left">
                            ...
                            <?php echo form_open('user/login_pegawai'); ?>
                            ...
                            <img src="<?php echo base_url() ?>/assets/uploads/keitoto_main_logo.svg ?>" alt="" class="rounded mb-4" style="width:16; height:16px;">
                        </div>
                    </div>
                </div>
            </div>
