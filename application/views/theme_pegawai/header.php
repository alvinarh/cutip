                    ...
                    <li class="nav-item <?php if($pp){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/Cuti/cutiSakit') ?>">Cuti Sakit</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/Cuti/cutiBesar') ?>">Cuti Besar</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/Cuti/cutiTahunan') ?>">Cuti Tahunan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/Cuti/cutiDiluarTN') ?>">Cuti Diluar Tanggungan Negara</a></li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item <?php if($pl){echo $a;} ?>">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/PermohonanCuti/cutiSakit') ?>">Cuti Sakit</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/PermohonanCuti/cutiBesar') ?>">Cuti Besar</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/PermohonanCuti/cutiTahunan') ?>">Cuti Tahunan</a></li>
                                <li class="nav-item"> <a class="nav-link text-white" href="<?= base_url('pegawai/PermohonanCuti/cutiDiluarTN') ?>">Cuti Diluar Tanggungan Negara</a></li>
                            </ul>
                        </div>
                    </li>

                    <li class="nav-item <?php if($p){echo $a;} ?>">
