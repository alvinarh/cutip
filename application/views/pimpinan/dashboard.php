...
<div class="col-md-4 stretch-card grid-margin" >
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Data Cuti Sakit<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></h4>
              ...
              <div class="col-md-4 stretch-card grid-margin" >
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('pimpinan/Cuti/cutiTahunan') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Data Cuti Tahunan<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></h4>
                    <h2 class="mb-5"><?= $cuti_tahunan ?></h2>
                      </a>
                  </div>
                </div>
                ...
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('pimpinan/Cuti/cutiBesar') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Data Cuti Besar<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></h4>
                    <h2 class="mb-5"><?= $cuti_besar ?></h2>
                      </a>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin" >
                <div class="card card-img-holder text-white" style="background: #4682B4;">
                  <div class="card-body">
                    <a href="<?= base_url('pimpinan/Cuti/cutiDiluarTN') ?>" style="text-decoration: none; color: white;">
                    <img src="<?php echo base_url('vendors/adminassets/assets/images/dashboard/circle.svg'); ?>" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Data Cuti Diluar Tanggungan Negara<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></h4>
                    <h2 class="mb-5"><?= $cuti_diluartn ?></h2>
                      </a>
                  </div>
                </div>
              </div>
