...
class Cuti extends CI_Controller
{
	...
	public function lapCutiSakit()
	{
		$data['title']          = 'Data Cuti Diluar Tanggungan Negara';
		$user = $this->db->query('select * from user where nama = "' . $_SESSION['nama'] . '"')->row();
		$data['laporan_cutiSakit'] = $this->M_Cuti->laporanCutiSakit($user->kode_pegawai);
		$data['user']   = $this->db->query('select * from user where nama = "' . $_SESSION['nama'] . '"')->row();
		$this->load->view('theme_pegawai/header', $data);
	...
	public function laporanCutiSakit()
	{
		...
		// $html = $this->load->view('pegawai/laporan_cuti/cuti_sakit', $this->data, true);
	...
	public function deleteDataCuti($id)
	{
		...
		redirect(base_url('pegawai/Cuti/index'));
	}
}
